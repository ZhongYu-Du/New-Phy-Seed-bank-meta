...
# Number of records with >80% germination and germination indices, by region.

```{r table1, echo = FALSE}
indi %>% group_by(Region) %>% tally
```

# Number of records with >80% germination and germination indices, by alpine strict vs. generalist.
